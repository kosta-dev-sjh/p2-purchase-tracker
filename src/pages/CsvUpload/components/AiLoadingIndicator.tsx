 ...
 *
 *       CSV 쪽은 엑셀 업로드 플로우 자체가 "AI 가 분석한다" 는 맥락을 이미 드러내고 있어
 *       (DEBUG_CSV_UPLOAD=true 이면 DebugToolbar 가 "AI만" / "파서만" 전략을 노출하는
 *       형태) 로딩 문구에서 AI 를 숨길 필요는 없습니다. OCR 쪽의 "2차 확인 중" 식 중립화는
